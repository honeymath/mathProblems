...
if answer == 'YES':
	print(rf"""
    You mentioned it is a positive semi-definite matrix. Please decompose it into $A=LL^T$ where $L$ is lower triangular matrix. Please enter your matrix $U$.
    """)
...
P = M*M.T
print("By what you've suggested, we have $UU^T = {latex(P)}$")
